...
import { cloneDirectivePilotState } from "./directive-pilot.js";
...
export const roleNavigation = {
  learner: ["overview", "governance", "scenarios", "catalog", "payments", "learning", "applications", "recognition", "assessment", "wallet", "notifications"],
  instructor: ["overview", "governance", "scenarios", "proposal", "frameworks", "applications", "programs", "assessment", "notifications"],
  externalInstructor: ["overview", "governance", "scenarios", "proposal", "frameworks", "applications", "assessment", "notifications"],
  coordinator: ["overview", "governance", "scenarios", "applications", "frameworks", "commission", "programs", "integrations", "reports", "notifications"],
  commission: ["overview", "governance", "scenarios", "commission", "frameworks", "applications", "assessment", "audit", "notifications"],
  studentAffairs: ["overview", "governance", "scenarios", "applications", "integrations", "wallet", "audit"],
  it: ["overview", "governance", "scenarios", "integrations", "audit", "reports"],
  finance: ["overview", "governance", "scenarios", "finance", "integrations", "reports", "audit", "notifications"],
  admin: ["overview", "governance", "scenarios", "applications", "frameworks", "commission", "programs", "integrations", "finance", "reports", "audit"]
};

export const pageMeta = {
  home: { label: "Pilot Ana Sayfa", icon: "home" },
  overview: { label: "Genel Bakış", icon: "grid" },
  governance: { label: "Yönerge ve Kural Merkezi", icon: "shield" },
  ...
  frameworks: { label: "TYÇ / AYÇ / TYYÇ Matrisleri", icon: "layers" },
...
export const initialState = {
  ...
  directivePilot: cloneDirectivePilotState(),
  scenarios: {
  ...
  programs: [
    {
      ...
      ects: 3,
      workload: 75,
      workloadComponents: { synchronous: 15, asynchronous: 12, preparation: 9, practice: 9, project: 9, independent: 9, assessment: 6, feedback: 6 },
      level: 6,
      mode: "Karma",
      remoteRate: 40,
      status: "commission",
    ...
    },
    {
      ...
      ects: 2,
      workload: 50,
      workloadComponents: { synchronous: 10, asynchronous: 8, preparation: 6, practice: 6, project: 6, independent: 6, assessment: 4, feedback: 4 },
      level: 6,
      mode: "Yüz yüze",
      remoteRate: 0,
      status: "active",
